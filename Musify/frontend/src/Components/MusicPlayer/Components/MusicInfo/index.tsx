...
import { SlideTopDiv, StyledWrapper } from "./styles";
...
export default function MusicInfo() {
  ...
  const { currentMusic, details, ShowMusicDetails } = useContext(MusicContext);

  return (
    <SlideTopDiv display={details}>
      {/* <h1>{currentMusic?.title}</h1>
        <MusicProgressLine/>
        <MusicProgressLine/>*/}
      <KeyboardArrowDownIcon onClick={ShowMusicDetails} />
